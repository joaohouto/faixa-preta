...
export default class MoveNew extends Component {
    ...
    saveMove = (e) => {
        ...
        api.post(`/moves/`, this.state.move)
        .then(response => {
            alert("Ok!");
            ...
            <div>
                ...
                <header className="jumbotron">
                    <div className="container">
                        <h2><UseAnimations animationKey="settings" size={40} style={{ position: 'relative', top: -3 }} /> Novo movimento</h2>
                    </div>
                </header>
                ...
                <div className="container" style={{ minHeight: 400 }}>
                    ...
                    { move != null ? (
                        <form onSubmit={(e) => this.saveMove(e)} method="post">
