...
class ActivityList extends Component {
	...
	loadTag = () => {
		...
		if (tag === "Kihon") this.setState({ listImage: kihonImage });
		if (tag === "Kata") this.setState({ listImage: kataImage });
		if (tag === "Kumite") this.setState({ listImage: kumiteImage });
		if (tag === "Exame") this.setState({ listImage: exameImage });
	};
	...
	handleSearch = async () => {
		...
		const response = await api.get(
			"activities?name=" + this.state.search + "&tags=" + this.state.tag
		);
